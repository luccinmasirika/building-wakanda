  ...
  return (
    <div className='container flex flex-col md:mx-auto md:px-32 py-4 items-center md:flex-no-wrap p-4 w-full bg-gray-50 relative z-10'>
      ...
      <p>
        ...
        direct communication, we are getting even closer to each other, able to
        team up as we take on the challenges of our time.
      </p>
      <p>
        When we say
        ...
        , it is first a message of self-love. We know our history and our worth.
        We use science to make Africa the paradise it is supposed to be.{' '}
        <strong>We first count on ourselves. </strong>We work together, ready to
        compete and to win. Baby steps after baby steps, we are building a
        temple through science, technology, engineering, art, mathematics,
        innovation, and love
      </p>
      <p>
        You can be one of us, regardless of your origin, age, race, gender,
        religion, and political views, if you believe thatwe can build together
        a better Africa:
        <strong>
          {' '}
          the Africa that empowers its people to be solutions to their problems.
        </strong>
      </p>
      <p>
      ...
      <p>
        ...
        determined; we dream big, do the work, make mistakes, learn from them,
        count our blessings, move forward, and make history. Started as an
        international online movement within the scientific and tech community,
        BuildingWakanda has produced{' '}
        <a href='https://twitter.com/hashtag/ForUsByUs?src=hashtag_click'>
          <strong>#ForUsByUs</strong>
        </a>{' '}
