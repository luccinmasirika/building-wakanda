...
export const Footer: React.FC<IFooterProps> = (props) => {
  return (
    <div className='container w-full p-4 md:px-32 flex flex-wrap-reverse md:flex-nowrap items-center justify-center md:justify-between h-48 bg-gray-800 mx-auto'>
